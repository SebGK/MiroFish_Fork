  ...
  <div class="simulation-panel">
    ...
    <div class="control-bar">
      <div class="status-group">
        ...
        <div class="platform-status twitter" :class="{ active: runStatus.twitter_running, completed: runStatus.twitter_completed }">
          ...
          <div class="platform-stats">
            ...
            <span class="stat">
              <span class="stat-label">Verstrichene Zeit</span>
      ...
      <div class="action-controls">
        ...
        >
          ...
          {{ isGeneratingReport ? 'Wird gestartet...' : 'Ergebnisbericht erstellen' }} 
    ...
    <div class="main-content-area" ref="scrollContainer">
      ...
      <div class="timeline-header" v-if="allActions.length > 0">
        <div class="timeline-stats">
          <span class="total-count">GESAMTEREIGNISSE: <span class="mono">{{ allActions.length }}</span></span>
      ...
      <div class="timeline-feed">
              ...
              <div class="card-body">
                ...
                <template v-if="action.action_type === 'QUOTE_POST'">
                  ...
                  <div v-if="action.action_args?.original_content" class="quoted-block">
                    <div class="quote-header">
                      ...
                      <span class="quote-label">@{{ action.action_args.original_author_name || 'Nutzer' }}</span>
                    </div>
                ...
                <template v-if="action.action_type === 'REPOST'">
                  <div class="repost-info">
                    ...
                    <span class="repost-label">Geteilt von @{{ action.action_args?.original_author_name || 'Nutzer' }}</span>
                  </div>
                ...
                <template v-if="action.action_type === 'LIKE_POST'">
                  <div class="like-info">
                    ...
                    <span class="like-label">Gefällt der Beitrag von @{{ action.action_args?.post_author_name || 'Nutzer' }}</span>
                  </div>
                ...
                <template v-if="action.action_type === 'FOLLOW'">
                  <div class="follow-info">
                    ...
                    <span class="follow-label">Folgt @{{ action.action_args?.target_user || action.action_args?.user_id || 'Nutzer' }}</span>
                  </div>
                </template>
                ...
                <template v-if="action.action_type === 'UPVOTE_POST' || action.action_type === 'DOWNVOTE_POST'">
                  <div class="vote-info">
                    ...
                    <span class="vote-label">{{ action.action_type === 'UPVOTE_POST' ? 'Positiv bewertet' : 'Negativ bewertet' }} Beitrag</span>
                  </div>
        ...
        <div v-if="allActions.length === 0" class="waiting-state">
          ...
          <span>Warte auf Agentenaktionen...</span>
        </div>
      </div>
    </div>
    ...
    <div class="system-logs">
      <div class="log-header">
        ...
        <span class="log-id">{{ simulationId || 'KEINE_SIMULATION' }}</span>
      </div>
...
const doStartSimulation = async () => {
  ...
  startError.value = null
  addLog('Parallele Simulation auf zwei Plattformen wird gestartet...')
...
const handleStopSimulation = async () => {
  ...
  try {
    ...
    if (res.success) {
      addLog('✓ Simulation wurde gestoppt')
      phase.value = 2
      stopPolling()
...
const handleNextStep = async () => {
  ...
  if (isGeneratingReport.value) {
    addLog('Anfrage zur Berichtserstellung wurde gesendet, bitte warten...')
    return
  }
  
  isGeneratingReport.value = true
  addLog('Berichtserstellung wird gestartet...')
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog(`✓ Aufgabe zur Berichtserstellung gestartet: ${reportId}`)
      
      // 跳转到报告页面
      router.push({ name: 'Report', params: { reportId } })
    } else {
      addLog(`✗ Start der Berichtserstellung fehlgeschlagen: ${res.error || 'Unbekannter Fehler'}`)
      isGeneratingReport.value = false
    }
  } catch (err) {
    addLog(`✗ Ausnahme beim Start der Berichtserstellung: ${err.message}`)
    isGeneratingReport.value = false
  }
}
...
onMounted(() => {
  addLog('Schritt 3 Simulation initialisiert')
  if (props.simulationId) {
    doStartSimulation()
  }
})
