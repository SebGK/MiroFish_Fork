    ...
    <div class="main-split-layout">
      ...
      <div class="left-panel report-style" ref="leftPanel">
        <div v-if="reportOutline" class="report-content-wrapper">
          ...
          <div class="report-header-block">
            <div class="report-meta">
              <span class="report-tag">Prognosebericht</span>
            ...
            >
              ...
              <div class="section-body" v-show="!collapsedSections.has(idx)">
                ...
                <div v-else-if="currentSectionIndex === idx + 1" class="loading-state">
                  ...
                  <span class="loading-text">{{ section.title }} wird erstellt...</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div v-if="!reportOutline" class="waiting-placeholder">
          ...
          <span class="waiting-text">Warte auf den Report-Agent...</span>
        </div>
      </div>
        ...
        <div class="action-bar-header">
          ...
          <div class="action-bar-tabs">
            ...
            >
              ...
              <span>Mit dem Report-Agent sprechen</span>
            </button>
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              >
                ...
                <span>{{ selectedAgent ? selectedAgent.username : 'Mit einer beliebigen Person der simulierten Welt sprechen' }}</span>
            ...
            >
              ...
              <span>Umfrage in die simulierte Welt senden</span>
            </button>
          </div>
        </div>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Schnelle Dialogvariante des Berichtsgenerators mit vier spezialisierten Werkzeugen und vollständigem MiroFish-Gedächtnis.</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">InsightForge · Tiefenanalyse</div>
                    <div class="tool-desc">Verknüpft reale Ausgangsdaten mit dem Simulationszustand und liefert mit Global-/Local-Memory tiefgehende Ursachenerklärungen über Zeit und Kontext hinweg.</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Rekonstruiert mit Graphdurchläufen die Ausbreitungspfade von Ereignissen und erfasst die Topologie des gesamten Informationsflusses.</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">QuickSearch · Schnellsuche</div>
                    <div class="tool-desc">Sofortige GraphRAG-Abfrage zur effizienten Extraktion konkreter Knoteneigenschaften und diskreter Fakten.</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">InterviewSubAgent · Virtuelle Interviews</div>
                    <div class="tool-desc">Führt selbstständig parallele Mehrfachinterviews mit Individuen der simulierten Welt und sammelt unstrukturierte Meinungen sowie psychologische Zustände.</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div v-if="chatTarget === 'agent' && selectedAgent" class="agent-profile-card">
            ...
            <div v-if="showFullProfile && selectedAgent.bio" class="profile-card-body">
              <div class="profile-card-bio">
                <div class="profile-card-label">Kurzprofil</div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Mit dem Report-Agent sprechen, um den Bericht besser zu verstehen' : 'Mit simulierten Individuen sprechen, um ihre Sichtweisen zu verstehen' }}
              </p>
            </div>
            <div 
              ...
              <div class="message-content">
                <div class="message-header">
                  <span class="sender-name">
                    {{ msg.role === 'user' ? 'Du' : (chatTarget === 'report_agent' ? 'Report-Agent' : (selectedAgent?.username || 'Agent')) }}
                  </span>
          ...
          <div class="survey-setup">
            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">Umfrageteilnehmende auswählen</span>
              ...
              <div class="selection-actions">
                ...
                <button class="action-link" @click="clearAgentSelection">Leeren</button>
              </div>
            </div>

            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">Umfragefrage</span>
              </div>
              <textarea 
                v-model="surveyQuestion"
                class="survey-input"
                placeholder="Gib die Frage ein, die du allen ausgewählten Personen stellen möchtest..."
                rows="3"
              ></textarea>
            </div>
...
const sendMessage = async () => {
  ...
  try {
    ...
    chatHistory.value.push({
      role: 'assistant',
      content: `Entschuldigung, es ist ein Fehler aufgetreten: ${err.message}`,
      timestamp: new Date().toISOString()
    })
  } finally {
...
const sendToReportAgent = async (message) => {
  addLog(`An Report-Agent gesendet: ${message.substring(0, 50)}...`)
  ...
  if (res.success && res.data) {
    ...
    addLog('Report-Agent hat geantwortet')
  } else {
...
const sendToAgent = async (message) => {
  if (!selectedAgent.value || selectedAgentIndex.value === null) {
    throw new Error('Bitte wähle zuerst ein simuliertes Individuum aus')
  }
...
const submitSurvey = async () => {
  ...
  addLog(`Umfrage wird an ${selectedAgents.value.size} Personen gesendet...`)
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog(`收到 ${surveyResults.value.length} Antworten`)
    } else {
      throw new Error(res.error || 'Anfrage fehlgeschlagen')
    }
  } catch (err) {
    addLog(`Versand der Umfrage fehlgeschlagen: ${err.message}`)
  } finally {
...
const loadReportData = async () => {
  ...
  try {
    addLog(`Berichtsdaten werden geladen: ${props.reportId}`)
    ...
    addLog(`Laden des Berichts fehlgeschlagen: ${err.message}`)
  }
}
...
const loadAgentLogs = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog('Berichtsdaten geladen')
    }
  } catch (err) {
    addLog(`Laden der Berichtsprotokolle fehlgeschlagen: ${err.message}`)
  }
}
...
const loadProfiles = async () => {
  ...
  try {
    ...
    addLog(`Laden der simulierten Individuen fehlgeschlagen: ${err.message}`)
  }
}
...
// Lifecycle
onMounted(() => {
  addLog('Schritt 5 Interaktion initialisiert')
  loadReportData()
  loadProfiles()
