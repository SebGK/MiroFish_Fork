...
const stepNames = ['Graph-Aufbau', 'Umgebungsaufbau', 'Simulation starten', 'Berichtserstellung', 'Interaktion']
...
const statusText = computed(() => {
  ...
  if (currentPhase.value === 0) return 'Ontologie wird erstellt'
...
const handleNextStep = (params = {}) => {
  if (currentStep.value < 5) {
    currentStep.value++
    addLog(`Wechsel zu Schritt ${currentStep.value}: ${stepNames[currentStep.value - 1]}`)
